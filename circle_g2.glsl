  ...
  // 縦回転 * 横回転
   ...
   for (float i = 0.0; i < 1000.0; i++) {
    vec3 circler = vec3(sin(rd * i) * 0.5, cos(rd * i) * 0.5,rd 0.0);
     circle += 0.00001 / abs(length(p - circler * r) - 0.3);
   }
    ...
    cr += 0.002 / (length(sin(p3.x * 29.0) * .05) * 1.) ;
    cg += 0.002 / (length(sin(p3.y * 29.0) * .05) * 1.) ;
    cr += 0.002 / (length(cos((p3.y - p3.x) * 21.0) * .08) * 1.) ;
    cb += 0.002 / (length(sin((p3.x + p3.y) * 21.0) * .08) * 1.) ;
    ...
    cg += 0.002 / (length(sin(p4.x * 29.0) * .05) * 1.) ;
    cb += 0.002 / (length(sin(p4.y * 29.0) * .05) * 1.) ;
    cg += 0.002 / (length(cos((p4.y - p4.x) * 21.0) * .08) * 1.) ;
    cr += 0.002 / (length(sin((p4.x + p4.y) * 21.0) * .08) * 1.) ;
    ...
    cb += 0.002 / (length(sin(p5.x * 29.0) * .05) * 1.) ;
    cr += 0.002 / (length(sin(p5.y * 29.0) * .05) * 1.) ;
    cb += 0.002 / (length(cos((p5.y - p5.x) * 21.0) * .08) * 1.) ;
    cg += 0.002 / (length(sin((p5.x + p5.y) * 21.0) * .08) * 1.) ;
